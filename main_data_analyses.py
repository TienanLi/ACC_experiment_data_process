...
def oscillation_analyses():
    ...
    # draw_oscillation_statistics_2(data,6,2,0,1,'Speed Level','Deceleration starting difference (s)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,3,0,1,'Speed Level','Deceleration ending difference (s)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,4,0,1,'Speed Level','Acceleration starting difference (s)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,5,0,1,'Speed Level','Acceleration ending difference (s)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,7,0,1,'Speed Level','Minimum speed difference (m per s)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,8,0,1,'Speed Level','Ending speed difference (m per s)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,9,0,1,'Speed Level','Acceleration rate difference (m per s2)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,10,0,1,'Speed Level','Deceleration rate difference (m per s2)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,14,0,1,'Speed Level','FV acceleration rate (m per s2)',stick_plot=True)
    # draw_oscillation_statistics_2(data,6,15,0,1,'Speed Level','FV deceleration rate (m per s2)',stick_plot=True)
    ...
    #                             'Acceleration rate ($m$/$s^2$)',stick_plot=True)
    # draw_oscillation_statistics_multiple_val(data, 6, [13,15], 0, 'Speed level',
    #                             'Deceleration rate ($m$/$s^2$)',stick_plot=True)
