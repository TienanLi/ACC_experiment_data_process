            ...
            for i in range(traj_df.index[0], traj_df.index[-1] - TH_horizon):
                ...
                if equlibrium:
                    ...
                    traj_df[['Time'] + speed_spacing_column][i:i + x].to_csv(os.getcwd() + \
                                        '/platooned_data/Cherasco_data/equilibrium_traj/equilibrium_%s_%s_%s_%s_%s_%s.csv'
...
def main():
    trajDict, vehicleInfoDict, statusDict = read_data_from_csv('/platooned_data/Cherasco_data/')
