...
def main_multi_day_prius(date_group, mode):
    ...
    for headway in headway_setting:
        ...
        for date in date_group:
            ...
            # if directly read equilibrium, 7 and 8 are already combined in one folder, no need to iterate dates
            break
    ...
    s_v_figure(speed1,spacing1,speed2,spacing2,'headway 1','headway 3','/platooned_data/03-08-2020/','-combined', veh='Prius')
...
def main_multi_day_tesla_x(date_group):
    ...
    spacing1, speed1, density1, volumn1, spacing2, speed2, density2, volumn2 = \
        get_FD_parameters(ACC_headway['1'], ACC_headway['3'])
    s_v_figure(speed1,spacing1,speed2,spacing2,'headway 1','headway 3','/platooned_data/02-23-2020/','-combined', veh='Model X')
...
def main_single_day(folder_name, date):
    ...
    vehName = 'Model 3' if date == 12 else 'Civic'

    s_v_figure(speed1, spacing1, speed2, spacing2, 'headway 1', 'headway 3', folder_name, '-combined', veh=vehName)
...
if __name__=='__main__':
    ...
    if (7 in experiment_date) and (experiment_date == [7,8]):
        main_multi_day_prius(experiment_date, 'normal')
